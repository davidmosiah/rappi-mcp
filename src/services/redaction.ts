const IDENTITY_KEY_PATTERN =
  /^(street|address|address_line|address_line_1|address_line_2|addressLine|full_address|fullAddress|shipping_address|shippingAddress|phone|phone_number|phoneNumber|mobile|email|e_mail|last_four|lastFour|lastFourDigits|last4|card_last4|cardLast4|cvv|cvc|card_number|cardNumber|pan)$/i;
